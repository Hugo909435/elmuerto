  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        tanks: resolve(__dirname, 'tanks.html'),
        chickenrun: resolve(__dirname, 'chickenrun.html'),
        sumo: resolve(__dirname, 'sumo.html'),
        charge: resolve(__dirname, 'charge.html'),
        synchro: resolve(__dirname, 'synchro.html'),
      },
    },
  },
});
